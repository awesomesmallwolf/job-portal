# Job Portal Node Server

Job portal to display Job Data and various informations from Indeed, ZipRecruiter and Glassdoor using Node.js, Express, and Mongoose.
...
open .env and modify the API keys
```
